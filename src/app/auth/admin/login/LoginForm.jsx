...
const LoginForm = () => {
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      alert("ورود معاونت با موفقیت انجام شد!");
    },
  });
          ...
          <div className="row g-4">
            <div className="col-12 d-lg-none">
              <div className="p-3 rounded-4 w-100 d-flex align-items-center justify-content-center bg-grd-primary">
                <img src="/assets/images/auth/school-man.svg" className="img-fluid" alt="Login Illustration" />
              </div>
            </div>
            ...
            <div className="col-lg-6 d-flex justify-content-center align-items-center">
              <div className="card-body">
                <div className="d-flex align-items-center mb-4">
                  ...
                  <h4 className="fw-bold mb-0"> ورود معاون </h4>
                </div>
